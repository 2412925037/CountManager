...
import com.tower.countmanager.chat.MyAudioManager;
...
public class AudioRecordButton extends Button {
    ...
    public AudioRecordButton(Context context, AttributeSet attrs) {
        ...
        audioManager = MyAudioManager.getInstance(FileUtil.getVoiceFilePath(getContext()));
    ...
    private void changeState(int state) {
        ...
        if (currentState != state) {
            ...
            switch (state) {
                case STATE_NORMAL:
                    setBackgroundResource(R.drawable.voice_bottom_button);
                    setText(R.string.voice_rcd_normal);

                    break;
                case STATE_RECORDING:
                    setBackgroundResource(R.drawable.voice_bottom_button_press);
                    setText(R.string.voice_rcd_recording);
                    if (isRecording) {
                        dialogManager.stateRecording();
                    }
                    break;
                case STATE_WANT_CANCEL:
                    setBackgroundResource(R.drawable.voice_bottom_button_press);
                    setText(R.string.voice_dialog_cancel);
                    dialogManager.stateWantCancel();
                    break;
