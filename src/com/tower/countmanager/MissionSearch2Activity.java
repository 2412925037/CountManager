...
public class MissionSearch2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mission_search2);
    ...
    public void onButtonClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.task_search_button:
            	if("全部".equals(strProvince)){
            		strProvince = "";
            	}
            	if("全部".equals(strCity)){
            		strCity = "";
            	}
            	if("全部".equals(strCounty)){
            		strCounty = "";
            	}
            	...
            	bundle.putString("county", strCounty);
            	bundle.putString("sign_user", personView.getText().toString());
            	
//            	if(!taskReport.getText().toString().equals("")){
...
//            	}
            	...
            	if("2".equals(Utils.getRoleId(mAppContext))){
            		...
            		if(taskStatus.getText().toString().equals(multiPleTaskStatus2[1])){
            		...
            		if(taskStatus.getText().toString().equals(multiPleTaskStatus[1])){
            			bundle.putString("task_status", "3");
            		}
            		if(taskStatus.getText().toString().equals(multiPleTaskStatus[2])){
            			bundle.putString("task_status", "3.5");
            		}
            		if(taskStatus.getText().toString().equals(multiPleTaskStatus[3])){
            			bundle.putString("task_status", "4");
            		}else{
            			bundle.putString("task_status", "");
            		}
            ...
            case R.id.mission_search_operate_time_from:
            	...
            	DateTimePickDialogUtil dateTimePicKDialog = new DateTimePickDialogUtil(
            			MissionSearch2Activity.this, taskTimefrom.getText().toString());
            ...
            case R.id.mission_search_operate_time_to:
            	...
            	DateTimePickDialogUtil dateTimePicKDialog1 = new DateTimePickDialogUtil(
            			MissionSearch2Activity.this, taskTimeto.getText().toString());
...
//    	Spinner userSpinner = (Spinner) findViewById(R.id.user_spinner_funnel);
//		UserSpinnerAdapter userAdapter = new UserSpinnerAdapter(FunnelActivity.this,
//				R.layout.spinner_for_instrument_panel, R.layout.layout_spinner_drop_down_list, users);
//		// 设置下拉列表的风格
//		// userAdapter.setDropDownViewResource(R.layout.layout_spinner_drop_down_list);
//		userSpinner.setAdapter(userAdapter);
//		userSpinner.setOnItemSelectedListener(new OnItemSelectedListener() {
//
//			@Override
//			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
//				currentMemberId = ((User) parent.getItemAtPosition(position)).getId();
//				loadFunnelData();
//				reset();
//			}
//
...
//		userSpinner.setVisibility(View.VISIBLE);
    	 ...
    	 province_spinner.setPrompt(getResources().getString(R.string.kq_search_province_title));
        province_adapter = ArrayAdapter.createFromResource(mAppContext, R.array.province_item1, R.layout.spinner_for_instrument_panel);
        province_adapter.setDropDownViewResource(R.layout.layout_spinner_drop_down_list);
...
//                            Log.v("test", "city: "+city_spinner.getSelectedItem().toString()+cityId.toString());
                            if(true)
                            {
                                ...
                                switch (provinceId) {
                                    case 0:
                                        select(county_spinner, county_adapter,countyOfquanbu[cityId]);
                                    break;
                                    case 1:
    ...
    private void select(Spinner spin, ArrayAdapter<CharSequence> adapter, int arry) {
        adapter = ArrayAdapter.createFromResource(context, arry, R.layout.spinner_for_instrument_panel);
        adapter.setDropDownViewResource(R.layout.layout_spinner_drop_down_list);
        spin.setAdapter(adapter);
        //spin.setSelection(0,true);
      
    }
    
    private int[] city = {R.array.dishi_province_item,R.array.beijin_province_item, R.array.tianjin_province_item, R.array.heibei_province_item, R.array.shanxi1_province_item, R.array.neimenggu_province_item, R.array.liaoning_province_item, R.array.jilin_province_item, R.array.heilongjiang_province_item, R.array.shanghai_province_item, R.array.jiangsu_province_item, R.array.zhejiang_province_item, R.array.anhui_province_item, R.array.fujian_province_item, R.array.jiangxi_province_item, R.array.shandong_province_item, R.array.henan_province_item, R.array.hubei_province_item, R.array.hunan_province_item, R.array.guangdong_province_item,  R.array.guangxi_province_item, R.array.hainan_province_item, R.array.chongqing_province_item, R.array.sichuan_province_item, R.array.guizhou_province_item, R.array.yunnan_province_item, R.array.xizang_province_item, R.array.shanxi2_province_item, R.array.gansu_province_item, R.array.qinghai_province_item, R.array.linxia_province_item, R.array.xinjiang_province_item, R.array.hongkong_province_item, R.array.aomen_province_item, R.array.taiwan_province_item};
    private int[] countyOfquanbu = {R.array.quyu_city_item};
