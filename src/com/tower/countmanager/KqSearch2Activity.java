...
public class KqSearch2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kq_search2);
    ...
    public void onButtonClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.kq_search_button:
            	...
            	bundle.putString("district", strCounty);
    ...
    public void loadSpinner() {
        ...
        province_adapter = ArrayAdapter.createFromResource(context, R.array.province_item1, R.layout.spinner_for_instrument_panel);
