...
//    public CreateSpinnerUtil(Context context, Spinner province_spinner,
//                             Spinner city_spinner, Spinner county_spinner) {
...
//        province_spinner.setPrompt(context.getString(R.string.kq_search_province_title));
...
//                    city_spinner.setPrompt(context.getString(R.string.kq_search_city_title));
...
//                            if(true)
//                            {
//                                county_spinner.setPrompt(context.getString(R.string.kq_search_county_title));
//                                switch (provinceId) {
//                                    case 0:
...
//    public CreateSpinnerUtil(Context context, String provinceName, String cityName, String defaultValue, Spinner county_spinner) {
//        this.context = context;
...
//        int proLocation = -1;
//        int cityLocation = -1;
//        String[] proTmp = context.getResources().getStringArray(R.array.province_item);
//        for(int i = 0; i < proTmp.length; i++) {
//            if(provinceName.contains(proTmp[i])) {
//                proLocation = i;
//                break;
//            }
//        }
//        String[] cityTmp = context.getResources().getStringArray(city[proLocation]);
//        for(int i = 0; i < city.length; i++) {
//            if(cityName.contains(cityTmp[i])) {
//                cityLocation = i;
//                break;
//            }
//        }
//        switch (proLocation) {
//            case 0:
//                select(county_spinner, county_adapter, countyOfBeiJing[cityLocation]);
//                break;
//            case 1:
//                select(county_spinner, county_adapter, countyOfTianJing[cityLocation]);
//                break;
//            case 2:
//                select(county_spinner, county_adapter, countyOfHeBei[cityLocation]);
//                break;
//            case 3:
//                select(county_spinner, county_adapter, countyOfShanXi1[cityLocation]);
//                break;
//            case 4:
//                select(county_spinner, county_adapter, countyOfNeiMengGu[cityLocation]);
//                break;
//            case 5:
//                select(county_spinner, county_adapter, countyOfLiaoNing[cityLocation]);
//                break;
//            case 6:
//                select(county_spinner, county_adapter, countyOfJiLin[cityLocation]);
//                break;
//            case 7:
//                select(county_spinner, county_adapter, countyOfHeiLongJiang[cityLocation]);
//                break;
//            case 8:
//                select(county_spinner, county_adapter, countyOfShangHai[cityLocation]);
//                break;
//            case 9:
//                select(county_spinner, county_adapter, countyOfJiangSu[cityLocation]);
//                break;
//            case 10:
//                select(county_spinner, county_adapter, countyOfZheJiang[cityLocation]);
//                break;
//            case 11:
//                select(county_spinner, county_adapter, countyOfAnHui[cityLocation]);
//                break;
//            case 12:
//                select(county_spinner, county_adapter, countyOfFuJian[cityLocation]);
//                break;
//            case 13:
//                select(county_spinner, county_adapter, countyOfJiangXi[cityLocation]);
//                break;
//            case 14:
//                select(county_spinner, county_adapter, countyOfShanDong[cityLocation]);
//                break;
//            case 15:
//                select(county_spinner, county_adapter, countyOfHeNan[cityLocation]);
//                break;
//            case 16:
//                select(county_spinner, county_adapter, countyOfHuBei[cityLocation]);
//                break;
//            case 17:
//                select(county_spinner, county_adapter, countyOfHuNan[cityLocation]);
//                break;
//            case 18:
//                select(county_spinner, county_adapter, countyOfGuangDong[cityLocation]);
//                break;
//            case 19:
//                select(county_spinner, county_adapter, countyOfGuangXi[cityLocation]);
//                break;
//            case 20:
//                select(county_spinner, county_adapter, countyOfHaiNan[cityLocation]);
//                break;
//            case 21:
//                select(county_spinner, county_adapter, countyOfChongQing[cityLocation]);
//                break;
//            case 22:
//                select(county_spinner, county_adapter, countyOfSiChuan[cityLocation]);
//                break;
//            case 23:
//                select(county_spinner, county_adapter, countyOfGuiZhou[cityLocation]);
//                break;
//            case 24:
//                select(county_spinner, county_adapter, countyOfYunNan[cityLocation]);
//                break;
//            case 25:
//                select(county_spinner, county_adapter, countyOfXiZang[cityLocation]);
//                break;
//            case 26:
//                select(county_spinner, county_adapter, countyOfShanXi2[cityLocation]);
//                break;
//            case 27:
//                select(county_spinner, county_adapter, countyOfGanSu[cityLocation]);
//                break;
//            case 28:
//                select(county_spinner, county_adapter, countyOfQingHai[cityLocation]);
//                break;
//            case 29:
//                select(county_spinner, county_adapter, countyOfNingXia[cityLocation]);
//                break;
//            case 30:
//                select(county_spinner, county_adapter, countyOfXinJiang[cityLocation]);
//                break;
//            case 31:
//                select(county_spinner, county_adapter, countyOfHongKong[cityLocation]);
//                break;
//            case 32:
//                select(county_spinner, county_adapter, countyOfAoMen[cityLocation]);
//                break;
//            case 33:
//                select(county_spinner, county_adapter, countyOfTaiWan[cityLocation]);
//                break;
//        }
////        county_adapter = ArrayAdapter.createFromResource(context, R.array.province_item, android.R.layout.simple_spinner_item);
