 ...
 *
 */
public class AssignmentTaskActivity extends Activity {
	...
	private Handler handlerLoad = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case Const.REQUEST_SERVER_SUCCESS:
				try {
					...
					if ("00".equals(success)) {
						Toast.makeText(AssignmentTaskActivity.this, jsonObject.getString("resultdesc"),
			...
			case Const.REQUEST_SERVER_FAILURE:
				Toast.makeText(AssignmentTaskActivity.this, R.string.app_connnect_failure, Toast.LENGTH_SHORT).show();
				break;
			}
		}
	};
...
//				}
		...
		case R.id.layout_time:
        	...
        	DateTimePickDialogUtil dateTimePicKDialog = new DateTimePickDialogUtil(
        			AssignmentTaskActivity.this, startTime);
	...
	public void showTaskPerson2Dialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this)
        
                .setMultiChoiceItems(taskRecievePersons, selected, new DialogInterface.OnMultiChoiceClickListener() {
                    @Override
